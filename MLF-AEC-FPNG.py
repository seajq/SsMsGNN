...
parser.add_argument('--save', type=str, help='path to save the final model', default='save/MF24/MLF-AEC-FPNG')
parser.add_argument('--loss_path', type=str, help='path to save the loss', default='loss/MF24/AEC-FPNG')
...
parser.add_argument('--subgraph_size', type=int, help='k', default=5)
...
parser.add_argument('--rb_lr', type=float, help='learning rate', default=1e-7)
...
parser.add_argument('--device', type=str, help='', default='cuda:2')
...
#  python MLF-AEC-FPNG.py --subgraph_size 7 --device cuda:4
