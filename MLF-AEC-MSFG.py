...
parser.add_argument('--save', type=str, help='path to save the final model', default='save/MF24/MLF-AEC-MSFG')
parser.add_argument('--loss_path', type=str, help='path to save the loss', default='loss/MF24/AEC-MSFG')
...
parser.add_argument('--device', type=str, help='', default='cuda:3')
...
#  python MLF-AEC-MSFG.py --device cuda:1 --valid_ratio 0.1
#  python MLF-AEC-MSFG.py --device cuda:2 --valid_ratio 0.3
#  python MLF-AEC-MSFG.py --device cuda:1 --valid_ratio 0.5
def run(args):
